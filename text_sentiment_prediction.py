...
train_data = pd.read_csv("/content/class134/static/assets/data_files/tweet_emotions.csv")    
training_sentences = []
...
model = load_model("/content/class134/static/assets/model_files/Tweet_Emotion.h5")
